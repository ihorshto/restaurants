<x-app-layout>
    ...
    <form action="{{route('restaurants.index')}}" method="GET" class="w-full mx-auto mb-6">
        ...
        <div class="relative">
            ...
            <input type="search" id="search" name="search" value="{{$search}}" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="{{__('messages.search.placeholder')}}" required />
